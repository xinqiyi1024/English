...
A.天气：It is treeible in spring.

B.点钟:It is eight now.
...
ta`k`e `o`ff	co`m`e `o`n `i`t

li`v`e `a`t	clea`n` `it` `u`p

#### 省读：辅辅相邻

si`t` down	par`t`-time

bi`g` cake	bu`t` `n`ow

goo`d` morning	no`t` that one

goo`d` night	boo`k`case

### 口语习惯

I am going to sit down on the grass.

I'm `gonna` sit down on the grass.
